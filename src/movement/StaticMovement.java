...
public class StaticMovement extends RandomWaypoint {
	...
	private int		p_x_center = 0, p_y_center = 0;
	private double	p_range = 0;
	...
	private StaticMovement(StaticMovement cmv) {
		super(cmv);
